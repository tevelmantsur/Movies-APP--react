...
let img_url
    ...
    return(!Actor ? "...Loading": Actor.map((e)=>{

if(!e.attributes.image){

    img_url = "https://pm1.narvii.com/6529/68caee022fc10f36230f46eff8e6e4386f5e11e7_hq.jpg"
}else{
...
let cardBackground={
    backgroundImage: "url(" + img_url + ")"  , height:"350px",
